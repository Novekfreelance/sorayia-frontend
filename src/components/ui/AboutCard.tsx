...
const AboutCard: React.FC<CardProps> = ({
  ...
  return (
    <div
      className={`flex flex-col justify-center bg-white ${itemsAlignement} ${className} relative gap-5 w-11/12 mx-auto my-5 p-10 h-[450px] rounded border shadow border-solid border-shadowColor`}
    >
