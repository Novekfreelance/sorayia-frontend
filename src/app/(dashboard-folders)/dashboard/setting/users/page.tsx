import CopyInviteLinkBtn from "@/components/dashboard/settingPafe/IvinteUserBtn";
import { UserAddIcon } from "@/components/icons/SvgIcons";
import { Button } from "@/components/ui/button";
import UsersTable from "./UsersTable";

const UsersPage = () => {
	const InviteLinkUrl = "https://sorayia/invite-link/99705fc2-5ac8-4ee4-bf91-ce9c6d7277e0";
  return (
    <div>
      ...
      <div className="flex justify-between items-center bg-gray-100 w-full rounded">
        <p className="bg-transparent pl-4">
          {InviteLinkUrl}
        </p>
        <CopyInviteLinkBtn linkUrl={InviteLinkUrl} />
      </div>
			<p className="text-xl-500 pt-2">Click <span className="text-primary">here</span> to reset this link</p>
      <div className="mt-8">
